...
public class iAdapter extends RecyclerView.Adapter<iAdapter.ViewHolder> {
    ...
    iAdapter(Context context, List<response> list, HashMap<String, String> map,
    ...
    @Override
    public void onBindViewHolder(@NonNull iAdapter.ViewHolder holder, int position) {
...
//
            ...
            name.setText(coins.getMarket().substring(0, coins.getMarket().length() - 3) + " / INR");
