...
public class uAdapter extends RecyclerView.Adapter<uAdapter.ViewHolder> {
    ...
    uAdapter(Context context, List<response> list, HashMap<String, String> map,
    ...
    public uAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new uAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull uAdapter.ViewHolder holder, int position) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void Bind(response coins) {
            ...
            String n = coins.getMarket().substring(0, coins.getMarket().length() - 4);
...
//
            ...
            name.setText(coins.getMarket().substring(0, coins.getMarket().length() - 4) + " / USDT");
            price.setText(decimalFormat.format(Double.parseDouble(coins.getLast_price())));
...
//            }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    i.putExtra("symbol", coins.getMarket().substring(0, coins.getMarket().length() - 4) + "USD");
